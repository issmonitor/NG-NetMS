...
sub devices {
    return {
        'X440-24t-10G'    => { sysObjectID_0 => ".1.3.6.1.4.1.1916.9.99.9", sysObjectID_0_string =>
            'RFC1213-MIB::sysObjectID.0 = OID: CISCO-PRODUCTS-MIB::ciscoC2500' },
        'X450a-24t-STACK' => { sysObjectID_0 => ".1.3.6.1.4.1.1916.2.93", sysObjectID_0_string =>
            'RFC1213-MIB::sysObjectID.0 = OID: CISCO-PRODUCTS-MIB::ciscoC2500' },
        'X670G2-48x-4q'   => { sysObjectID_0 => ".1.3.6.1.4.1.1916.2.195", sysObjectID_0_string =>
            'RFC1213-MIB::sysObjectID.0 = OID: CISCO-PRODUCTS-MIB::ciscoC2500' },
    };
}
#=============================================
